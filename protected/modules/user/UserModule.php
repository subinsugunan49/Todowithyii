...
class UserModule extends CWebModule
{
	...
	public $returnLogoutUrl = array("index.php?r=user/login");
	...
	public static function sendMail($email,$subject,$message) {
		...
		$emaiContent = Yii::app()->sendgrid->createEmail(); 
					$emaiContent->setHtml($message)  
						->setSubject($subject)   
						->addTo($email)  
						->setFrom('info@element8me.com');  
					Yii::app()->sendgrid->send($emaiContent);
